	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"chat:slashCommand.wantsToRun": "CodiDroid wants to run slash command:",
				"chat:slashCommand.didRun": "CodiDroid ran slash command:",
			}
...
describe("ChatRow - runSlashCommand tool", () => {
	...
	it("should display runSlashCommand ask message with command only", () => {
		...
		expect(getByText("CodiDroid wants to run slash command:")).toBeInTheDocument()
	...
	it("should display runSlashCommand say message", () => {
		...
		expect(getByText("CodiDroid ran slash command:")).toBeInTheDocument()
