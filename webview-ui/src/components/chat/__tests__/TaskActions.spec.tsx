	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				...
				"chat:task.connectToCloudDescription": "Sign in to CodiDroid Cloud to share tasks",
				...
				"cloud:cloudBenefitsTitle": "Connect to CodiDroid Cloud",
...
describe("TaskActions", () => {
	...
	describe("Unauthenticated User Login Flow", () => {
		...
		it("shows connect to cloud option when not authenticated", () => {
			...
			expect(screen.getByText("Connect to CodiDroid Cloud")).toBeInTheDocument()
