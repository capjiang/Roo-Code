...
describe("WebAuthService", () => {
	...
	describe("login", () => {
		...
		it("should handle errors during login", async () => {
			...
			await expect(authService.login()).rejects.toThrow("Failed to initiate CodiDroid Cloud authentication")
			expect(mockLog).toHaveBeenCalledWith("[auth] Error initiating CodiDroid Cloud auth: Error: Crypto error")
		})
	})
	...
	describe("handleCallback", () => {
		...
		it("should handle invalid parameters", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Invalid CodiDroid Cloud sign in url")
		...
		it("should validate state parameter", async () => {
			...
			await expect(authService.handleCallback("code", "different-state")).rejects.toThrow(
				"Failed to handle CodiDroid Cloud callback",
			)
		...
		it("should successfully handle valid callback", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Successfully authenticated with CodiDroid Cloud")
		})
	...
	describe("logout", () => {
		...
		it("should clear credentials and call Clerk logout", async () => {
			...
			expect(mockShowInfo).toHaveBeenCalledWith("Logged out from CodiDroid Cloud")
		})
