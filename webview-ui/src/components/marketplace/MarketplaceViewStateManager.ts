 ...
 *
 * This class manages the state for the marketplace view in the CodiDroid extensions interface.
 *
 * IMPORTANT: Fixed issue where the marketplace feature was causing the CodiDroid extensions interface
